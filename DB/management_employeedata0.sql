...
CREATE TABLE `employeedata` (
  ...
  `EMPCONTACTNO` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`ID`)
...
INSERT INTO `employeedata` VALUES (2,'Dilsha','minuwangoda','dilsha@gmail.com','0776512345');
...
-- Dump completed on 2022-05-15  3:41:46
